...
#     ${HIVE_HOME}/conf/'
docker cp apache-hive-3.1.2-bin hadoop-spark-master:/usr/local/hive
docker cp mariadb-java-client-2.7.0.jar hadoop-spark-master:/usr/local/hive/lib/
docker exec -it hadoop-spark-master /bin/bash -c \
